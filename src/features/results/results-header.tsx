...
type Props = { attempts: Attempt[]; onRetryCurrent: () => void; onRetrySession: () => void; onBack: () => void };

export function ResultsHeader({ attempts, onRetryCurrent, onRetrySession, onBack }: Props) {
