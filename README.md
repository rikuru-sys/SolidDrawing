...
乱数、出題生成、設定保存、タイマー、描画履歴、SVG生成、自動評価、お気に入り、各画面の表示ロジックなどをVitestで確認しています。Playwrightでは、描画から結果表示、見本のみ、お気に入りに加え、デスクトップ・横長・縦長画面の共通表示条件をChromiumで確認します。自動評価では6種類の立体と3種類の見本表示の組み合わせに加え、通常線と影線の分離、影の中心合わせ、形状・影の配点を固定データで確認しています。
